...
require 'sliday_backup/logger/console'
require 'sliday_backup/logger/logfile'
require 'sliday_backup/logger/syslog'
require 'sliday_backup/logger/fog_adapter'
...
module SlidayBackup
  class Logger
    ...
    ##
    # The Logger is available as soon as SlidayBackup is loaded, and stores all
    ...
    ##
    # If errors are encountered by SlidayBackup::CLI while preparing to perform
    # the backup jobs, this method is called to dump all messages to the
    # console before SlidayBackup exits.
    def abort!
      console = Console.new
