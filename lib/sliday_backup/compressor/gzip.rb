...
module SlidayBackup
  module Compressor
    class Gzip < Base
      ...
      # stored using SlidayBackup's `RSync` Storage option.
      #
      ...
      # available on your system. If it's not available, SlidayBackup will log a
      ...
      ##
      # Creates a new instance of SlidayBackup::Compressor::Gzip
