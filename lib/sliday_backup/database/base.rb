...
module SlidayBackup
  module Database
    ...
    class Base
          ...
          unless database_id
            if model.databases.select {|d| d.class == self.class }.count > 1
              ...
              Logger.warn Error.new(<<-EOS)
                ...
                When multiple Databases are configured in a single SlidayBackup Model
                ...
                SlidayBackup has auto-generated an identifier (#{ database_id }) for this
      ...
      def database_name
        @database_name ||= self.class.to_s.sub('SlidayBackup::', '') +
